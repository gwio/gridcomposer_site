  ...
  <div class="w3-container w3-content">
    <div class="w3-row blockspace">
      ...
      <div class="w3-col l5 w3-display-container">
        <img class="manualIMG" src="images/favicon.png" style="width:50%; max-width:500px;  margin: auto; display: block;">
      </div>
    </div>
  </div>
</div>
              ...
              <li class="manual">Tap or swipe on the other grids to cycle through them without going back to the home screen.</li>
                <li class="manual">The columns on the left are showing the active global scale. Grey columns are possible notes while colored columns are actually playing, corresponding to the color shades on the grid. It's also possible that multiple shapes share the same note. Tapping on the scale indicator allows you to move up and down in the scale.</li>
                  <li class="manual">With the two buttons below, you can cycle through the instruments and adjust their attack value. This value is also modified by the <a href="manual.php#tempoView">tempo settings</a>, higher speeds have a faster attack and vice versa.</li>
                    <li class="manual">Per default all grids are linked to the same global scale. You can toggle the <a href="manual.php#localHarmony">local harmony view</a> and tap on “set notes” to use custom scale settings for this grid. You can always switch back to the global harmony.</li>
            </ul>
          </div>
          <div class="w3-rest"></div>
        </div>
      ...
      <div class="w3-col m12 l7">
        <div class="w3-row">
          <div class="w3-col fixText">
            ...
            <ul class="manual">
<li class="manual">Switch the “Global Harmony” to “Local Harmony” in the default edit mode and select the “Set Notes” button to access the local harmony view screen.</li>
...
<li class="manual">A grid which is set to “Local Harmony” mode will appear in color in the <a href="manual.php#harmonyView">harmony</a> view and it will state “local” instead of “global”. You will be able to freely move up and down in half notes instead of octave.</li>
<li class="manual">If you want to grid to switch back to the global harmony, just tap the “Local Harmony” button.</li>
      ...
      <div class="w3-col m12 l7">
        <div class="w3-row">
          ...
          <ul class="manual">
            ...
            <li class="manual">Having many isolated shapes and using both reverb and delay effects might affect the performance and sound quality on old devices like the iPhone 4s or iPad 2. But in the most cases GridComposer will runs just fine on those older hardware.</li>
          </ul>
          </div>
          <div class="w3-rest"></div>
        </div>
      ...
      <div class="w3-col m12 l7">
        <div class="w3-row">
          <div class="w3-col fixText">
            ...
            <li class="manual">On OSX you need to open the “Audio-Midi-Setup” app and setup a network connection. Check out this <a href="http://musicappblog.com/wireless-network-midi-ipad-to-mac/">guide</a> for more information.</li>
