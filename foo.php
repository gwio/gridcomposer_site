  ...
  <div class="w3-container w3-content" style="padding-top:2.55%">
    <div class="w3-row">
      <div class="w3-col s12 l6 w3-display-container">
        <img src="images/appIconBig.png" style="width:30%; max-width:500px; margin: auto; display: block;">
      </div>
      <div class="w3-col s12 l6 w3-left" style="padding-top: 1.5%;">
        <p class="footerTxt" style="font-weight: 500;">GridComposer was developed by <a style="border-bottom: 1px solid #BBBBBB;" href="http://www.gwiozda.net">Christian Gwiozda</a></p>
  ...
  <div class="w3-container w3-content">
    <div class="w3-row">
      <div class="w3-col s12 w3-center">
        <p class="footerTxt" style="font-size:0.75em; color:#777777; font-weight: 500;">&copy; 2016 <a href="http://www.gwiozda.net">Christian Gwiozda</a></p>
      </div>
    </div>
  </div>
